...
@include('header')
    ...
    <div class="container">
        <div class="bg-light text-center abs-center mt-3 p-3 rounded">
            ...
            <hr>
            <h3>Buffet</h3>
            <p>Esta patata con carne cremosa y blanca destaca por ser muy sabrosa y resulta deliciosa frita.
            </p>
            <hr>
            <h3>Red Pontiac</h3>
            <p>La variedad Red Pontiac, también denominada roja, puede estar varios días en la nevera sin problemas y es idónea para hacer guisos. Este tipo de patata es roja por fuera y blanca por dentro.
            </p>
            <hr>
